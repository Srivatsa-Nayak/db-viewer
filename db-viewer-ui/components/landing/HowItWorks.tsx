...
export const HowItWorks = () => {
    ...
    return (
        <section className="section-wash-tinted border-y border-[var(--surface-line)] py-20 sm:py-28">
            <div className="mx-auto max-w-6xl px-6">
                        ...
                        return (
                            <React.Fragment key={step.title}>
                                ...
                                >
                                    ...
                                    <span
                                        aria-hidden
                                        className="pointer-events-none absolute -right-2 -top-3 text-[64px] font-bold leading-none text-blue-600/[0.06]"
                                    >
                                        {i + 1}
                                    </span>
                ...
                <div ref={ref as React.Ref<HTMLDivElement>} className="relative">
                    ...
                    <div
                        aria-hidden
                        className="pointer-events-none absolute -inset-x-8 -inset-y-6 rounded-[2rem] bg-gradient-to-tr from-blue-500/12 via-indigo-500/10 to-sky-400/12 blur-2xl"
                    />
